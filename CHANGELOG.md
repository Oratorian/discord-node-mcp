...
### Changed
- Automated publishing now uses OIDC authentication (no npm tokens required)
- Packages now include provenance attestations automatically

## [1.1.3] - 2025-01-29

### Fixed
- Fixed markdown output format for all list tools (guilds, members, channels, roles, messages, emojis, stickers, events, invites, bans, audit logs, automod rules, webhooks)
- Fixed TypeScript type signature for `formatResponse` to properly handle arrays
